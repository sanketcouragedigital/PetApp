...
import com.couragedigital.peto.Connectivity.FilterFetchPetMateBreedList;
import com.couragedigital.peto.Connectivity.FilterFetchPetMateCategoryList;
import com.couragedigital.peto.PetMateListFilter;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private class FilterFetchPetMateCategory extends AsyncTask<List, Void, Void> {
            ...
            protected Void doInBackground(List... params) {
                ...
                FilterFetchPetMateCategoryList filterFetchPetMateCategoryList = new FilterFetchPetMateCategoryList(v);
        ...
        private class FilterFetchPetMateBreed extends AsyncTask<List, Void, Void> {
            ...
            protected Void doInBackground(List... params) {
                ...
                FilterFetchPetMateBreedList filterFetchPetMateBreedList = new FilterFetchPetMateBreedList(v);
