...
public class Campaign_List_Details extends AppCompatActivity implements View.OnClickListener {
    String campaignId = "";
    ...
    String contactNo="";
    String collecetedAmountCampaign="";
    String remainingAmountCampaign="";
    ...
    TextView campaignRemainingAmount;
    TextView campaignCollectedAmount;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.campaign_list_details);
        ...
        SessionManager sessionManager = new SessionManager(Campaign_List_Details.this);
        ...
        campaignRemainingAmount = (TextView) findViewById(R.id.remainingAmount);
        campaignCollectedAmount = (TextView) findViewById(R.id.collectedAmount);
        campaignLastDate = (TextView) findViewById(R.id.lastDate);
        donateNowButton = (Button) findViewById(R.id.donateNowButton);
    ...
    public class FetchImageFromServer extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String url) {
            ...
            if(urlForFetch.equals(firstImagePath)) {
                ...
                campaignDetailsFirstImageThumbnail.setOnClickListener(Campaign_List_Details.this);
            }
            if(urlForFetch.equals(secondImagePath)) {
                ...
                campaignDetailsSecondImageThumbnail.setOnClickListener(Campaign_List_Details.this);
            }
            if(urlForFetch.equals(thirdImagePath)) {
                ...
                campaignDetailsThirdImageThumbnail.setOnClickListener(Campaign_List_Details.this);
            }
        }
    }
    ...
    public void onBackPressed() {
        Campaign_List_Details.this.finish();
    }
        ...
        if(v.getId() == R.id.donateNowButton) {
            ...
            if(danationAmount == null || danationAmount.isEmpty()) {
                ...
                if(donatedAmount < minAmount  || donatedAmount==0){
                    ...
                    Intent gotoDonation = new Intent(Campaign_List_Details.this,NGO_Donation.class);
    ...
    protected void onPause() {
        super.onPause();
        PackageManager pm = Campaign_List_Details.this.getPackageManager();
        ComponentName component = new ComponentName(Campaign_List_Details.this, NetworkChangeReceiver.class);
