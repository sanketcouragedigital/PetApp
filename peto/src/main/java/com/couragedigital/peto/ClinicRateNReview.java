...
//                        Toast.LENGTH_SHORT).show();
    ...
    protected void onPause() {
        super.onPause();
        PackageManager pm = ClinicRateNReview.this.getPackageManager();
        ComponentName component = new ComponentName(ClinicRateNReview.this, NetworkChangeReceiver.class);
