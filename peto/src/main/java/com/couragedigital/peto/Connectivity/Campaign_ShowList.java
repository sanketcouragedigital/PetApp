...
public class Campaign_ShowList {
    ...
    public Campaign_ShowList(Campaign_List campaignList) {
        context = campaignList;
    }

    public static List campaignFetchList(final List<CampaignListItem> campaignLists, final RecyclerView.Adapter adapter, String url, final ProgressDialog progressDialog) {

        JsonObjectRequest campaignFetchReq = new JsonObjectRequest(Request.Method.GET, url, null,
        ...
        AppController.getInstance().addToRequestQueue(campaignFetchReq);
