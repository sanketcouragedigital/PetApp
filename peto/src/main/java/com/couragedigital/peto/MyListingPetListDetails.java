...
public class MyListingPetListDetails extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onPause() {
        super.onPause();
        PackageManager pm = MyListingPetListDetails.this.getPackageManager();
        ComponentName component = new ComponentName(MyListingPetListDetails.this, NetworkChangeReceiver.class);
