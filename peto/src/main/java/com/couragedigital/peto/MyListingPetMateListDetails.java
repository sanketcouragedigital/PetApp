...
public class MyListingPetMateListDetails extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onPause() {
        super.onPause();
        PackageManager pm = MyListingPetMateListDetails.this.getPackageManager();
        ComponentName component = new ComponentName(MyListingPetMateListDetails.this, NetworkChangeReceiver.class);
