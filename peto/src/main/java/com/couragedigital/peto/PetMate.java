...
import com.couragedigital.peto.Connectivity.PetMateFormUpload;
...
public class PetMate extends BaseActivity implements View.OnClickListener {
    ...
    public class FetchCategoryListFromServer extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            try {
                PetCategorySpinnerList petCategorySpinnerList = new PetCategorySpinnerList(PetMate.this);
    ...
    public class FetchBreedListCategoryWiseFromServer extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            try {
                PetBreedsSpinnerList petBreedsSpinnerList = new PetBreedsSpinnerList(PetMate.this);
    ...
    protected void onPause() {
        super.onPause();
        PackageManager pm = PetMate.this.getPackageManager();
        ComponentName component = new ComponentName(PetMate.this, NetworkChangeReceiver.class);
