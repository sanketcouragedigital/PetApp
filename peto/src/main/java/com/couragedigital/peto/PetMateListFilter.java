...
import com.couragedigital.peto.model.FilterOptionList;
...
public class PetMateListFilter extends AppCompatActivity {
    ...
    protected void onPause() {
        super.onPause();
        PackageManager pm = PetMateListFilter.this.getPackageManager();
        ComponentName component = new ComponentName(PetMateListFilter.this, NetworkChangeReceiver.class);
