...
import com.couragedigital.peto.Adapter.ShelterListAdapter;
import com.couragedigital.peto.Connectivity.PetFetchShelterList;
import com.couragedigital.peto.Listeners.PetFetchShelterListScrollListener;
...
public class TabFragmentShelter extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.tab_fragment_shelter, container, false);
        return v;
    }
    ...
    private class FetchListFromServer extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... url) {
            try {
                ...
                PetFetchShelterList petFetchShelterList = new PetFetchShelterList(v);
