...
public class TabFragmentStoresDetails extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onPause() {
        super.onPause();
        PackageManager pm = TabFragmentStoresDetails.this.getPackageManager();
        ComponentName component = new ComponentName(TabFragmentStoresDetails.this, NetworkChangeReceiver.class);
