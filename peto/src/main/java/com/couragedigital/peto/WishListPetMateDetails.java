...
public class WishListPetMateDetails extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onPause() {
        super.onPause();
        PackageManager pm = WishListPetMateDetails.this.getPackageManager();
        ComponentName component = new ComponentName(WishListPetMateDetails.this, NetworkChangeReceiver.class);
