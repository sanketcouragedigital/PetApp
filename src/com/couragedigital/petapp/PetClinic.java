    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (value == 0) {
            ...
            if (gpsTracker.getIsGPSTrackingEnabled()) {
                String savedLatitude = String.valueOf(gpsTracker.latitude);
                latitude = savedLatitude;

                String savedLongitude = String.valueOf(gpsTracker.longitude);
            ...
            url = url + "?method=ClinicByCurrentLocation&format=json&currentPage=" + current_page + "&latitude=" + latitude + "&longitude=" + longitude + "";
            recyclerView.smoothScrollToPosition(0);
            recyclerView.addOnScrollListener(new PetFetchClinicListScrollListener(linearLayoutManager, current_page) {
